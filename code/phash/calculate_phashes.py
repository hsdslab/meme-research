...
if __name__ == "__main__":
    ...
    parser.add_option("-d", "--dataset_df", dest='dataset_df', help="A path to a parquet DataFrame with the path of the images to calculate phashes")

    (options, args) = parser.parse_args()

    DF_PATH = options.dataset_df
